...
interface ColorSettingsPanelProps {
  ...
  effectiveBorderRadius: PresetState['colorPresetBorderRadius']
  effectiveCardShadow: PresetState['colorPresetCardShadow']
...
export function ColorSettingsPanel({
  ...
  const updateBorderRadius = (_event: React.FormEvent<HTMLSelectElement>, value: string) => {
    editorActions.setQuickStartExtras({ colorPresetBorderRadius: value as PresetState['colorPresetBorderRadius'] })
  }

  const updateCardShadow = (_event: React.FormEvent<HTMLSelectElement>, value: string) => {
    editorActions.setQuickStartExtras({ colorPresetCardShadow: value as PresetState['colorPresetCardShadow'] })
  }
