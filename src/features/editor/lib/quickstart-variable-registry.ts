...
const QUICK_START_VARIABLE_GROUPS: Record<QuickStartVariableCategory, QuickStartVariableDefinition[]> = {
  color: [
    ...
    { name: '--quickstart-primary-h', category: 'color', detail: 'Quick Start hue', includeInGeneratedRoot: true },
    { name: '--quickstart-primary-s', category: 'color', detail: 'Quick Start saturation', includeInGeneratedRoot: true },
    { name: '--quickstart-primary-l', category: 'color', detail: 'Quick Start lightness', includeInGeneratedRoot: true },
    { name: '--quickstart-primary-invert-l', category: 'color', detail: 'Quick Start contrast lightness', includeInGeneratedRoot: true },
    ...
    { name: '--quickstart-secondary-h', category: 'color', detail: 'Quick Start hue', includeInGeneratedRoot: true },
    { name: '--quickstart-secondary-s', category: 'color', detail: 'Quick Start saturation', includeInGeneratedRoot: true },
    { name: '--quickstart-secondary-l', category: 'color', detail: 'Quick Start lightness', includeInGeneratedRoot: true },
    { name: '--quickstart-secondary-invert-l', category: 'color', detail: 'Quick Start contrast lightness', includeInGeneratedRoot: true },
